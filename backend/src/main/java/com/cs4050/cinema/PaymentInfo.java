...
public class PaymentInfo {
    ...
    private void encryptData(String cardNumber, String cvc) throws Exception {
        ...
        this.encryptedCardNumber = cipher.doFinal(cardNumber.getBytes(StandardCharsets.UTF_8));

        // Encrypt the cvc
        cipher.init(Cipher.ENCRYPT_MODE, secretKey);
        this.encryptedCvc = cipher.doFinal(cvc.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public String decryptCardNumber(SecretKey secretKey) throws Exception {
        ...
        byte[] decryptedCardNumber = cipher.doFinal(this.encryptedCardNumber);
    ...
    public String decryptCvc(SecretKey secretKey) throws Exception {
        ...
        Cipher cipher = Cipher.getInstance(ALGORITHM);
        cipher.init(Cipher.DECRYPT_MODE, secretKey);
        byte[] decryptedCvc = cipher.doFinal(this.encryptedCvc);
